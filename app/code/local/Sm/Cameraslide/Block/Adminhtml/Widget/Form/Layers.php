...
//        $this->setChild( 'addLayerVideoBtn', $addLayerBtn );
    ...
    public function getDivLayersStyle()
    {
        ...
        if($slide->getId())
        {
            return sprintf('width:%s; height:%s;', $slide->getData('slide_width') ? $slide->getData('slide_width').'%' : '960px', $slide->getData('slide_height') ? $slide->getData('slide_height').'px' : '450px');
        }
    }

//    public function checkSetHeight()
//    {
//        $slide = Mage::registry('slide');
//        if((($slide->getData('slide_height')) && ($slide->getData('height_type') == "%")) || ($slide->getData('slide_height') == 'auto'))
//        {
//            return sprintf("height: 550px;");
//        }else{
//            return "";
//        }
//    }
