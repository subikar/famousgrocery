...
//console.log('sliders'); // hàm debug kiểm tra js
"use strict";
var slideHideMarginLeftRight = function slideHideMarginLeftRight()
{
...
CameraSlide.prototype = {
    ...
    index: 0,
    layers: {},
    //layerParams: "time_transitions|time_delay_transitions|width|height|min_width|min_height|bg_color|color|top|left|class|enable_link|text|title_link|alt_link|target_link|link|animation|data_easing|data_easein|data_easeout|data_fxin|data_fxout|data_fadein|data_fadeout|data_rotatein|data_rotateout|data_mobile_easing|text_align|font_family|font_size|textUnderline|textBold|textItalic".split("|"),
    layerParams: "time_transitions|time_delay_transitions|width|height|min_width|min_height|bg_color|color|top|left|class|alt_image|text|data_easein|data_easeout|data_fxin|data_fxout|data_fadein|data_fadeout|text_align|font_family|font_size|textUnderline|textBold|textItalic".split("|"),
    //layerParams: "width|height|min_width|min_height|bg_color|color|top|left|right|bottom|enable_link|text|title_link|alt_link|target_link|link|animation|data_easing|data_mobile_easing|text_align|font_family|font_size|textUnderline|textBold|textItalic".split("|"),
    videoParams: "loop|control|autoplay|muted".split("|"),
    slideParams: "",
    cssState: "normal",
    cssUsingHover: 2,
    styles: new Hash(),
    ...
    setInAnimation: function() {
        ...
        var a = jQuery("#animation_preview"),
            ...
            //thisRotateIn = $("layer_data_rotatein").value,
    ...
    setOutAnimation: function(){
        ...
        var a = jQuery("#animation_preview"),
            ...
            //thisRotateOut = $("layer_data_rotateout").value,
        ...
        a.each(function () {
            ...
            //var defaults = {transPeriod : 1500} ;
            //var opts = $.extend({}, defaults, opts);

            //console.log("undefined" != thisRotateOut && "false" != thisRotateOut);
        })
        setTimeout(function () {
            this.setInAnimation();
        }.bind(this), dataTime);
            ...
            if (b) {
                ...
                if ("TABLE" === b.tagName) b.select("a").each(function(a) {
                    ...
                    if (this.selectedLayer) {
                        ...
                        //this.selectedLayer.style.right = this.selectedLayer.params.right ? this.selectedLayer.params.right+"px" : '';
                        this.selectedLayer.style.left = this.selectedLayer.params.left ? this.selectedLayer.params.left+"px" : '';
                        //this.selectedLayer.style.bottom = this.selectedLayer.params.bottom ? this.selectedLayer.params.bottom+"px" : "";
                        ...
                        if ("text" === a) {
                            if ("text" === this.selectedLayer.params.type) {
                                ...
                                //this.selectedLayer.innerHTML = this.selectedLayer.params.text.escapeHTML();

                                //this.selectedLayer.innerHTML = this.selectedLayer.params.text.escapeHTML()+" "+'<a href="" title="'+this.selectedLayer.params.title_link.escapeHTML()+'">'+this.selectedLayer.params.title_link.escapeHTML()+'</a>';
                            }
                        ...
                        //else if('enable_link' === a){
                        //    if ("text" === this.selectedLayer.params.type) {
                        //        if(this.selectedLayer.params.enable_link === '1')
                        //        {
                        //            this.selectedLayer.innerHTML = this.selectedLayer.params.text.escapeHTML()+" "+'<a href="" title="'+this.selectedLayer.params.title_link.escapeHTML()+'">'+this.selectedLayer.params.title_link.escapeHTML()+'</a>';
                        //        }else{
                        //            this.selectedLayer.innerHTML = this.selectedLayer.params.text.escapeHTML();
                        ...
                        //else if('link' === a){
                        //    if ("text" === this.selectedLayer.params.type) {
                        //        var http_link = stri (this.selectedLayer.params.link) ?
                        //        this.selectedLayer.innerHTML = this.selectedLayer.params.text.escapeHTML()+" "+'<a href="" title="'+this.selectedLayer.params.title_link.escapeHTML()+'">'+this.selectedLayer.params.title_link.escapeHTML()+'</a>';
                        //    }
                        //}
    ...
    renderLayerHtml: function(a) {
        if(a.classes === "hide")
        {
            var b = new Element("div", {
                ...
                "class": "slide_layer hide tp-caption "
            });
        }else{
            var b = new Element("div", {
                id: "slide_layer_" + a.serial,
                "class": "slide_layer tp-caption "
            });
        }
        b.setStyle({
        ...
        switch (a.type) {
            ...
            default:
                //if(a.enable_link === 1)
                //{
                //    b.innerHTML = a.text+" "+'<a title="'+a.title_link+'" alt="'+a.alt_link+'">'+a.title_link+'</a>';
                //}else{
                //    b.innerHTML = a.text;
                //}
                b.innerHTML = a.text;
                ...
                b.style.top = a.top;
                //b.style.bottom = a.bottom;
                b.style.left = a.left;
                //b.style.right = a.right;
    ...
    updateContainer: function() {
        ...
        if (a) switch (a.value) {
          ...
          case "video":
            var b = "video" === a.value ? $("data_src_video") : $("sliders_bg_color");
            var hide = $('data_video').value;
            var type = $("service_video");
            var video_width = $('video_width').value;
            var video_height = $('video_height').value;
            var video_class = $('video_class').value;
            var video_left = $('video_left').value ? 'margin-left:'+$('video_left').value+';' : 'margin-left:auto;';
            var video_top = $('video_top').value ? 'margin-top:'+$('video_top').value+';' : 'margin-top:auto;';
            if(b && b.value)
            {
                var http = "https://";
                var c = 0 === b.value.indexOf("http") ? b.value : this.mediaUrl + b.value;
                if (type) switch (type.value) {
                    case "youtube":
                        var loop = ($('video_loop').value === 'loop') ? "loop=1" : "loop=0";
                        var autoplay = ($('video_autoplay').value === 'autoplay') ? "autoplay=1" : "autoplay=0";
                        var controls = ($('video_controls').value === 'controls') ? "controls=1" : "controls=0";
                        var autohide = ($('video_autohide').value === '1') ? "autohide=1" : "autohide=0";
                        var showinfo = ($('video_showinfo').value === '1') ? "showinfo=1" : "showinfo=0";
                        var colorcontrolsyoutube = ($('video_colorcontrolsyoutube').value === 'white') ? "color=white" : "color=red";
                        if($("src_video").value.length === 0)
                        {
                            this.container.setStyle({
                                backgroundImage: "url(" + c + ")"
                            });
                            ...
                            if(hide === 'hide')
                            {
                                ...
                                var src_video = http+"www.youtube.com/embed/"+$("src_video").value+"?"+controls+"&"+autoplay+"&"+loop+"&"+showinfo+"&"+autohide+"&"+colorcontrolsyoutube;
                                var ifr = jQuery("#divLayers");
                                this.container.setStyle({
                                    backgroundImage: "url(" + c + ")"
                                });
                                ifr.html("<iframe class='"+video_class+"' src="+src_video+" width="+video_width+" height="+video_height+" style="+video_top+video_left+" frameborder="+0+" webkitAllowFullScreen mozallowfullscreen allowFullScreen"+'></iframe>"');
                            }
                        }
                    break;
                    case "player.vimeo.com":
                        ...
                        var loop = ($('video_loop').value === 'loop') ? "loop=1" : "loop=0";
                        var autoplay = ($('video_autoplay').value === 'autoplay') ? "autoplay=1" : "autoplay=0";
                        //var autopause = ($('video_autopause').value === '1') ? "autopause=1" : "autopause=0";
                        var colorvimeo = ($('video_colorcontrolsvimeo').value) ? "color="+$('video_colorcontrolsvimeo').value : "color=00ADEF";
                        if($("src_video_2").value.length === 0)
                        {
                            this.container.setStyle({
                                backgroundImage: "url(" + c + ")"
                            });
                            ...
                            if(hide === 'hide')
                            {
                                ...
                                var src_video = http+"player.vimeo.com/video/"+$("src_video_2").value+"?"+autoplay+"&"+loop+"&"+colorvimeo;
                                //var ifr = jQuery("#divLayers");
                                this.container.setStyle({
                                    backgroundImage: "url(" + c + ")"
                                });
                    ...
                    case "html5":
                        ...
                        var mp4_video = $("html5_mp4_video").value;
                        var webm_video = $("html5_webm_video").value;
                        var ogg_video = $("html5_ogg_video").value;
                        var loop = $('video_loop').value;
                        var controls = $('video_controls_html5').value;
                        var autoplay = $('video_autoplay').value;
                        var muted = $('video_muted').value;

                        if(mp4_video)
                        {
                            var source_mp4  = "<source src="+http+mp4_video+" type="+'video/mp4'+">";
                        }
                        if(webm_video)
                        {
                            var source_webm = "<source src="+http+webm_video+" type="+'video/webm'+">";
                        }
                        if(ogg_video)
                        {
                            var source_ogg  = "<source src="+http+ogg_video+" type="+'video/ogg'+">";
                        }

                        if(mp4_video || webm_video || ogg_video)
                        {
                            if(hide === 'hide')
                            {
                                this.container.setStyle({
                                ...
                                ifr.html("<video class='"+video_class+"' width="+video_width+" height="+video_height+" "+loop+' '+controls+' '+autoplay+' '+muted+" style="+video_top+video_left+">"+source_mp4+source_webm+source_ogg+"</video>");
                            }
                        }
                        else{
                            this.container.setStyle({
    ...
    addLayer: function(a) {
        ...
        //if (void 0 == a.right) a.right = "";
        //if (void 0 == a.bottom) a.bottom = "";
        ...
        //if (void 0 == a.data_easing) a.data_easing = $("layer_data_easing").value;
        ...
        //if (void 0 == a.data_rotatein) a.data_rotatein = $("layer_data_rotatein").value;
        //if (void 0 == a.data_rotateout) a.data_rotateout = $("layer_data_rotateout").value;
        //if (void 0 == a.data_mobile_easing) a.data_mobile_easing = $("layer_data_mobile_easing").value;
        if (void 0 == a.speed) a.speed = 500;
        if (void 0 == a.class) a.class = "";
        if (void 0 == a.alt_image) a.alt_image = "";
        //if (void 0 == a.time_delay_transitions) a.time_delay_transitions = 700;
        //if (void 0 == a.enable_link) a.enable_link = 2;
        //if (void 0 == a.title_link) a.title_link = "";
        //if (void 0 == a.alt_link) a.alt_link = "";
        //if (void 0 == a.link) a.link = "";
        //if (void 0 == a.target_link) a.target_link = "_blank";
        if (void 0 == a.time_transitions) {
            var c_time = 500 * a.order;
            //var c_time = 500 + 400 * this.count;
            a.time_transitions = c_time > this.delay ? this.delay : c_time;
        }
        if (void 0 == a.time_delay_transitions) {
            var c = 1000 * a.order;
            //var c = 1500 + 1000 * this.count;
                ...
                switch (a.params.type) {
                            ...
                            default :
                                switch (b) {
                                    ...
                                    //case "alt_link":
                                        disableElement(this.layerParamsElm[b]);
                                        //$("layer_title_link").readOnly = true;
                                        //$("layer_alt_link").readOnly = true;
                                        //$("layer_target_link").
                                        //$("layer_link").readOnly = true;
    ...
    hideAllLayers: function() {
        for (var a in this.layers){ this.hideLayer(a, true); this.setSttAllClasses(a,true);}
    },
    ...
    showAllLayers: function() {
        for (var a in this.layers){this.showLayer(a, true); this.setSttAllClasses(a, false);}
    },
