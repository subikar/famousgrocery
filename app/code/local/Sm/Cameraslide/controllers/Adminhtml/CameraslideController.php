...
//        }
    ...
    public function videoAction()
    {
        ...
        $this->_addContent( $this->getLayout()->createBlock('sm_cameraslide/adminhtml_sliders_video'));
...
//        $slide_id = $this->getRequest()->getParam('slide_id') ? $this->getRequest()->getParam('slide_id') : array($this->getRequest()->getParam('id'));
//        $slide = $this->getRequest()->getPost();
//        $stt_slide = $slide['status'] ? $slide['status'] : null;
//        foreach($slide_id as $sid)
//        {
//            $model = Mage::getModel('sm_cameraslide/slide')->load($sid);
//            if($model->getId())
//            {
//                $model->setData('status', $stt_slide);
//                $model->save();
//                $this->_getSession()->addSuccess(Mage::helper('sm_cameraslide')->__('The Status Slide change success'));
//                $this->_redirectReferer();
//            }else{
//                $this->_redirectReferer();
//                $this->_getSession()->addError(
//                    Mage::helper('sm_cameraslide')->__('An error occurred while change status the slide')
//                );
//            }
//        }
//    }
...
//                if($this->getRequest()->getParam('back'))
//                {
//                    $redirectPath = '*/*/addSliders';
//                    $redirectParams = array(
//                        'sid'   => $slideId,
//                        'id'    => $modelSliders->getId()
//                    );
//                }else{
//                    $redirectPath = '*/*/edit';
//                    $redirectParams = array(
