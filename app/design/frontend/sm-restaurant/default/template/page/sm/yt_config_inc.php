...
$attributes = array();
if( Mage::getConfig()->getNode('modules/Sm_Stationery') ){
	$_config = Mage::helper('stationery/data')->get($attributes);
}
// Layout
...
global $var_yttheme;
$var_yttheme = new YtTheme('sm_stationery', $_params, $paramscookie);
