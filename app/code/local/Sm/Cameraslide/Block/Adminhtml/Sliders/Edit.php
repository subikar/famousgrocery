...
//            $mediaUrl               = Mage::getBaseUrl('media').'sm'.'/'.'cameraslide'.'/';
...
//            {
//                $this->updateButton('save', 'label', Mage::helper('sm_cameraslide')->__('Save'));
...
//            }
//            if(Mage::helper('sm_cameraslide/admin')->isActionAllowed('delete')) {
//                $this->updateButton('delete', 'label', Mage::helper('sm_cameraslide')->__('Delete'));
//            }else{
//                $this->_removeButton('delete');
//            }
//
//            $this->_formScripts[] = "
//            editForm = new varienForm('sliders_form', '');
//                function toggleEditor() {
//					if (tinyMCE.getInstanceById('sliders_form') == null){
//						tinyMCE.execCommand('mceAddControl', false, 'sliders_form');
//					}else{
//						tinyMCE.execCommand('mceRemoveControl', false, 'sliders_form');
//				    }
//				}
//
//				function saveAndContinueEdit(){
//					editForm.submit($('sliders_form').action+'back/addSliders/sid/{$this->getIdSlide()}');
//				}
//
//                function duplicate(){
...
//        public function _getAnims()
//        {
//            $anims = array();
//            $collection = Mage::getModel('sm_cameraslide/animation')->getCollection();
//        }
...
//            $this->updateButton('save', 'onclick', "setLocation('{$saveUrl}');");
